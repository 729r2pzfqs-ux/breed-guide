#!/usr/bin/env python3
"""
Apply all Polish translations to breed pages.
"""

import re
from pathlib import Path
from pl_translations import BEST_FOR, NOT_IDEAL, TEMPERAMENT_TAGS

PL_BREEDS_DIR = Path(__file__).parent / "pl" / "breeds"
...
def apply_translation(html_content):
    """Apply translations to Polish HTML."""
...
def main():
    breeds = sorted([f for f in PL_BREEDS_DIR.glob("*.html") if f.stem != "index"])
